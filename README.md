...
- [XOR-AI Telegram Bot](#xor-ai-telegram-bot)
...
4. Вы можете дальше работать полученным текстом:
...
<div style="border: 4px solid #CF0; margin: 1rem; padding: 1rem; padding: 1rem; text-align: center;">
<b><a href="https://t.me/Kubice">XOR AI | Tg: @Kubice</a></b>
</div>